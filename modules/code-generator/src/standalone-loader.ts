...
import type { IPublicTypeProjectSchema, ResultDir } from '@rchh/lowcode-types';
...
export const DEFAULT_WORKER_JS = `https://cdn.jsdelivr.net/npm/@rchh/lowcode-code-generator@${packageVersion}/dist/standalone-worker.min.js`;
