...
Use the [registerMetadataTransducer API](/lowcode-engine/docs/api/material#registermetadatatransducer) to modify metadata. If snippets are involved, update those configurations as well.
