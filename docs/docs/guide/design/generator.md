...
| **NPM 包** | **代码仓库** | **说明** |
| --- | --- | --- |
| [@rchh/lowcode-code-generator](https://www.npmjs.com/package/@rchh/lowcode-code-generator) | [alibaba/lowcode-engine](https://github.com/alibaba/lowcode-engine)（子目录：modules/code-generator）| 出码模块核心库，支持在 node 环境下运行，也提供了浏览器下运行的 standalone 模式 |
